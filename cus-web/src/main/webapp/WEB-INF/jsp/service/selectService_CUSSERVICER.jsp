		...
		<tr valign="top">
			<td height="30">
				<table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					<tr>
						<td class="fftd">
							<form name="recordform" id="recordform" action="${ctx}/service/selectService_CUSSERVICER">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">
											<!-- 状态： -->
				...
				<table width="98%" border="1" cellpadding="5" cellspacing="0" align="center" style="border: #c2c6cc 1px solid; border-collapse: collapse;">
					...
					<c:forEach items="${requestScope.pageInfo.list}" var="record" varStatus="stat">
						...
						<%-- 	<td>${record.cusagree }</td> --%>
							...
							<td align="center" >
								<c:if test="${ record.status=='A'}">
									<a href="${ctx }/service/agreeApply?id=${record.id }&cusid=${record.cusid}">同意申请</a>
								</c:if>
							</td>
						</tr>
					</c:forEach>
...
<script type="text/javascript">
    ...
    /* 跳转功能 */
    function pageTo(pn) {
	var myHref = "${ctx}/service/selectService_CUSSERVICER?pn=" + pn
