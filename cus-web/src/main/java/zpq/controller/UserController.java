...
public class UserController {
    ...
    public ModelAndView addManager(Manager manager, HttpServletRequest request, HttpSession session, ModelAndView mv) {
        Msg msg = managerService.addManager(manager);
    ...
    public ModelAndView updateMyInfo_Manager(Manager manager, HttpServletRequest request, HttpSession session,
                                             ModelAndView mv) {
        Msg msg = managerService.updateManager(manager, (String) session.getAttribute("account"));
        if (msg.getCode() == 100) {
    ...
    public ModelAndView updateMyInfo_Css(Css css, HttpServletRequest request, HttpSession session, ModelAndView mv) {
    ...
    public ModelAndView deletsManyUsers(String ids, ModelAndView mv,
                                        @RequestParam(value = "pn", defaultValue = "1") Integer pn,
                                        @RequestParam(value = "selectUserHunmanType", defaultValue =
                                                Constrants.MANAGER) String selectUserHunmanType,
                                        String selectUserAccount) {
    ...
    public ModelAndView updateManager(ModelAndView mv, Manager manager, String oriAccount) {
        Msg msg = managerService.updateManager(manager, oriAccount);
        logger.info(msg.getExtend().get("msg").toString());
        mv.setViewName("redirect:/user/selectUsers");
        return mv;
    }
